...
<head>
    ...
    <!--====== Title ======-->
    <title>Civil Engineering(CEN) | easyUniversity</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Civil Engineering(CEN)</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Department</a></li>
                                <li class="breadcrumb-item active" aria-current="page">CEN</li>
                            </ol>
                        </nav>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="corses-singel-left mt-30">
                        <div class="title">
                            <h3>Civil Engineering(CEN)</h3>
                        </div> <!-- title -->
                        
                        <div class="corses-singel-image pt-50">
                            <img src="images/CEN.png" alt="Courses">
                                ...
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-description">
                                        <div class="singel-description pt-40">
                                            <h6>Summery</h6>
                                            <p> <b>Civil Engineering(CEN)</b> design, build, supervise, operate, and maintain construction projects and systems in the public and private sector, including roads, buildings, airports, tunnels, dams, bridges, and systems for water supply and sewage treatment.

Civil engineers generally work in a variety of locations and conditions. Many spend time outdoors at construction sites so that they can monitor operations or solve problems onsite. Most work full time.</p>
                                        </div>
                            ...
                            <?php include("login/dbcon.php"); 
                                    $sql = "SELECT * from subject WHERE dept_id='CEN'";
    ...
    { 
        ...
        $row_users = mysqli_num_rows($result); 
                 ...
                 $query = "SELECT * FROM teacher where dept_id = 'CEN'"; 
                 $result = mysqli_query($conn, $query); 
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6">
                            <div class="course-features mt-30">
                               ...
                               <ul>
                                    <li><i class="fa fa-clock-o"></i>Total Courses : <span><?php echo $row_users_cen;?></span></li>
