...
// var_dump($conn);
// exit;       
$uploaded_by_query = mysqli_query($conn,"select * from teacher where teacher_id = '$session_id'");
        ...
        if (!file_exists($newname)) {
            ...
            if ((move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $newname))) {
               ...
               // echo "INSERT INTO files (fdesc,floc,fdatein,teacher_id,class_id,fname,uploaded_by) VALUES ('$filedesc','$newname',NOW(),'$session_id','$id[$i]','$name','$uploaded_by')";
                // exit;
				mysqli_query($conn,"INSERT INTO files (fdesc,floc,fdatein,teacher_id,subject_id,fname,uploaded_by) VALUES ('$filedesc','$newname',NOW(),'$session_id','$id[$i]','$name','$uploaded_by')");
