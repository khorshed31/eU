            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
						...
						<li><a href="#"><b>Teacher</b></a><span class="divider">/</span></li>
								...
								?>								
								    ...
								    <form  method="post" id="change_password" class="form-horizontal">
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="password" id="new_password" name="new_password" placeholder="New Password"pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
											<div id="message">
