...
if(isset($_POST['submit']))
{
  $t_id=$_POST['t_id'];
  $course=$_POST['course'];
$ret=mysqli_query($conn,"update courseenrolls set t_id='$t_id' where course='$course'");
if($ret)
{
...
{
  $_SESSION['msg']="Error : Assign not successfull";
}
}
?>
<!DOCTYPE html>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Assign Course  </h1>
                    </div>
                </div>
                <div class="row" >
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
    ...
    <label class="col-lg-6 control-label" for="t_id">Teacher ID </label>
  ...
  <div class="form-group">
    <label class="col-lg-6 control-label" for="course">Enrolling Course </label>
    <select class="form-control" name="course" required="required">
   <option value="">Select Course</option>   
   <?php 
        $sql=mysqli_query($conn,"select * from courseenrolls");
        while($row=mysqli_fetch_array($sql))
        {
        ?>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive table-bordered">
                                <table class="table">
                                    ...
                                    <tbody>
<?php
$sql=mysqli_query($conn,"select * from courseenrolls,teacher where courseenrolls.t_id = teacher.t_id");
$cnt=1;
while($row=mysqli_fetch_array($sql))
{
?>
                                        ...
                                        <tr>
                                            <td><?php echo $cnt;?></td>
                                            <td><img src="../<?php echo htmlentities($row['photo']);?>" alt="photo" width="30%" height="30%"></td>
