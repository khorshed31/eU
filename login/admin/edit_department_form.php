                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<form method="post">
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" value="<?php echo $row['dept_id']; ?>" id="focusedInput" name="dn" type="text" placeholder = "Department ID">
                                          </div>
                                        </div>
 ...
 mysqli_query($conn,"update department set department_name = '$d' , dept_id  = '$dn' where department_id = '$get_id' ");
 ?>
 <script>
