...
$query="update  userregistration set firstName=?,lastName=?,imageName=?,contactNo=?,updationDate=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssssisi',$fname,$lname,$imageName,$contactno,$udate,$aid);
$stmt->execute();
...
<html lang="en">
  ...
  $aid=$_SESSION['id'];
    ...
    <title><?php echo $row->firstName;?>&nbsp;<?php echo $row-> lastName;?> | easyUniversity</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Main CSS-->
    <link rel="stylesheet" type="text/css" href="css_das/main.css">
    <!-- Font-icon css-->
    <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
  </head>
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html">easyUniversity</a>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="rounded-circle" src="uploads/<?php echo $row->imageName;?>"
						 alt="" width="25%">&nbsp;&nbsp;&nbsp;
        <div>
        <p class="app-sidebar__user-name"><?php echo $row->firstName;?>&nbsp;<?php echo $row-> lastName;?></p>
    ...
    <main class="app-content">
      <div class="row user">
        <div class="col-md-12">
          <div class="profile">
            <div class="info"><img class="rounded-circle" src="uploads/<?php echo $row->imageName;?>"
						 alt="" width="70%">
             <p class="app-sidebar__user-name"><?php echo $row->firstName;?>&nbsp;<?php echo $row-> lastName;?></p>
              <p>User</p>
            </div>
                ...
                <form>
                  <div class="row mb-4">
                    <div class="col-md-4">
                      ...
                      <input class="form-control" name="fname" id="fname" type="text" value="<?php echo $row->firstName;?>">
                    </div>
                    <div class="col-md-4">
                  ...
                  <div class="col-md-8 mb-4">
                      <label>Email</label>
                      <input readonly="" class="form-control" type="text" value="<?php echo $row->regNo;?>">
                    </div>
                    <div class="col-md-8 mb-4">
                      <label>Email</label>
                      <input readonly="" class="form-control" type="text" value="<?php echo $row->email;?>">
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-md-8 mb-4">
                      <label>Mobile No</label>
                      <input class="form-control" type="text" name="contact" id="contact" value="<?php echo $row->contactNo;?>">
                    </div>
                    <div class="col-md-8 mb-4">
                      <label>Gender</label>
                      <input readonly="" class="form-control" type="text" value="<?php echo $row->gender;?>">
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-md-8 mb-4">
                    <img class="rounded-circle" src="uploads/<?php echo $row->imageName;?>"
						 alt="" width="25%">
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-md-8 mb-4">
                      <label>Change Image</label>
                      <input type="file" id="imageName"value="<?php echo $row->imageName;?>" name="fileToUpload" class="form-control">
                    </div>
                  </div>
                  <?php } ?>
                  <div class="row mb-10">
    ...
    <script src="js_das/jquery-3.3.1.min.js"></script>
    <script src="js_das/popper.min.js"></script>
    <script src="js_das/bootstrap.min.js"></script>
    <script src="js_das/main.js"></script>
