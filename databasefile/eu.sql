...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2021 at 10:13 PM
...
INSERT INTO `payment` (`payment_id`, `student_id`, `pay_image`, `subject_id`, `date`, `uploaded_by`, `teacher_class_id`, `pay_status`) VALUES
(4, 229, 'admin/uploads/2961_File_475-4757107_search-engine-optimization-google-seo-icon-png.jpg', 45, '2021-11-28 19:02:26', 'Khorshed Alom', 194, 1),
(5, 229, 'admin/uploads/9437_File_999.jpg', 44, '2021-11-28 19:02:42', 'Khorshed Alom', 195, 1);
...
INSERT INTO `student` (`student_id`, `firstname`, `lastname`, `username`, `password`, `email`, `versity`, `location`, `status`) VALUES
(229, 'Khorshed', 'Alom', 'eu-402', '1234', 'khorshed@gmail.com', 'Stamford University Bangladesh', 'uploads/137-1378551_commerce-vector-cartoon-business-man-hq-image-free (2).png', 'Unregistered'),
(231, 'Sumon', 'Kumar', 'eu-121', '1234', 'sumon@gmail.com', 'Stamford University Bangladesh', 'uploads/istockphoto-1220619825-170667a.jpg', 'Unregistered'),
(232, 'Emon', 'Ali', 'eu-502', '1234', 'emon@gmail.com', 'Stamford University Bangladesh', 'uploads/NO-IMAGE-AVAILABLE.jpg', 'Unregistered'),
(233, 'Test', 'demo', 'eu-473', '1234', 'test@gmail.com', 'Stamford University Bangladesh', 'uploads/NO-IMAGE-AVAILABLE.jpg', 'Unregistered');
...
(113, 'admin', '2021-11-28 19:00:59', '', 15);
...
--
ALTER TABLE `student`
  MODIFY `student_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=234;
...
--
ALTER TABLE `teacher_class`
  MODIFY `teacher_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=198;
...
--
ALTER TABLE `user_log`
  MODIFY `user_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;
COMMIT;
