                                ...
                                <div class="feed-activity-list">
                                    ...
                                    <div class="feed-element">
                                        ...
                                        <div class="media-body ">
                                            ...
                                            <strong>Fullname :</strong>                    <?php echo $rowaccess['name'];   ?><strong> <br>
                                      </div>
                                    </div>
									<div class="feed-element">
                                        <a href="#" class="pull-left">
									...
									<div class="feed-element">
                                        ...
                                        <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>University :</strong>                    <?php echo $rowaccess['versity'];   ?> <strong> <br>
                                        </div>
                                    </div>
									<div class="feed-element">
                                        <a href="#" class="pull-left">
									...
									<div class="feed-element">
                                        ...
                                        <div class="media-body ">
                                            <small class="pull-right text-navy"></small>
                                            <strong>Year :</strong>                    <?php echo $rowaccess['syear'];   ?><strong>  <br>
                                        </div>
                                    </div>
									 <div class="feed-element">
                                        <a href="#" class="pull-left">
