<link rel="shortcut icon" href="images/favicon.png" type="image/png">
    ...
    <!--====== Slick css ======-->
    <link rel="stylesheet" href="css_main/slick.css">

    <!--====== Animate css ======-->
    <link rel="stylesheet" href="css_main/animate.css">
    
    <!--====== Nice Select css ======-->
    <link rel="stylesheet" href="css_main/nice-select.css">
    
    <!--====== Nice Number css ======-->
    <link rel="stylesheet" href="css_main/jquery.nice-number.min.css">
    ...
    <!--====== Default css ======-->
    <link rel="stylesheet" href="css_main/default.css">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-contact text-lg-left text-center">
                            <ul>
                                <li><img src="images/all-icon/map.png" alt="icon"><span>Stamford University Bangladesh</span></li>
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="support-button float-right d-none d-md-block">
                            <div class="support float-left">
                                ...
                                <div class="cont">
                                    <a href="tel:0123456789"><p>Need Help? call us</p>
