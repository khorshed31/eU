                ...
                <div class="col-lg-8">
                    <div class="corses-singel-left mt-30">
                        ...
                        <div class="corses-singel-image pt-50">
                            <img src="images/CSE.png" alt="Courses">
                        ...
                        <div class="corses-tab mt-30">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-description">
                                        <div class="singel-description pt-40">
                                            ...
                                            <p><b>Computer Science and Engineering </b>involves the design and development of systems based on computers 
                                                and complex digital logic devices. These systems find use in such diverse tasks as 
                                                computation, communication, entertainment, information processing, artificial 
                                                intelligence, and control. Computer engineers will be very much involved with the 
                                                “Information Highway.”</p>
                                        </div>
                                        <div class="singel-description pt-40">
                                            <h6>Requrements</h6>
                                            <p>Computer Engineering graduates are equipped for careers as engineers, electrical designers, electrical engineers, design and applications engineers, test engineers, power systems engineers, and product engineers. .</p>
                                        </div>
                                ...
                                <table class="table">
                                    ...
                                    $sql = "SELECT * from course WHERE dept_id=1";
